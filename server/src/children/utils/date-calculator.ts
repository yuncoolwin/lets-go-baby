...
const WORK_WEEKENDS_2026 = new Set<string>([
  '2026-02-14', // 春节调休（春节7天假，补前一个周六）
  '2026-02-28', // 春节调休（春节7天假，补后一个周六）
  '2026-03-28', // 清明调休（清明4月6日周一多放1天，补前一个周六）
  '2026-05-09', // 劳动节调休（劳动节5天假，补后一个周六）
  '2026-10-10', // 国庆调休（国庆7天假，补后一个周六）
])
